...
// @description  Adds new "AutoSell" button near "Sell" to set selling price, tick SSA checkbox, confirm sale & close dialog automatically.
// @version      1
// @author       Silmaril
// @namespace    https://github.com/SOLiNARY
// @downloadURL  https://github.com/SOLiNARY/steam-market-auto-seller/raw/master/steam-market-auto-seller.js
// @updateURL    https://github.com/SOLiNARY/steam-market-auto-seller/raw/master/steam-market-auto-seller.js
// @license      MIT License
...
(function() {
    ...
    $(document).on("click", ".auto_sell_button", async function(e){
        ...
        let price = (Number(priceBlock.substring(0, delimiter).replace(/[^0-9.-]+/g,"")) - 0.01).toFixed(2);
